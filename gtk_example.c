...
static int 
system_notify_cb(lws_state_manager_t *mgr, lws_state_notify_link_t *link, int current, int target)
{
	printf("SYSTEM NOTIFY CALLBACK!!!\n");
...
t1_main (gpointer user_data)
{
	...
	loop = g_main_loop_new(t1_mc, FALSE);
